...
/* We do not support C11 <threads.h>.  */
 ...
 {"isPower2", (funct_t) isPower2, (funct_t) test_isPower2, 1, "! ~ & ^ | + << >>", 20, 6,
  {{TMin, TMax},{TMin,TMax},{TMin,TMax}}},
 ...
 {"logicalNeg", (funct_t) logicalNeg, (funct_t) test_logicalNeg, 1,
    "~ & ^ | + << >>", 12, 5,
  {{TMin, TMax},{TMin,TMax},{TMin,TMax}}},
//[LJW] add test function in here
 {"bitAnd", (funct_t) bitAnd, (funct_t) test_bitAnd, 2, "| ~", 8, 1, {{TMin, TMax}, {TMin, TMax}, {TMin, TMax}}},
 {"logical_OR", (funct_t) logical_OR, (funct_t) test_logical_OR, 2, "| & ^ !", 10, 1, {{TMin, TMax}, {TMin, TMax}, {TMin, TMax}}},
 {"concatenate", (funct_t) concatenate, (funct_t) test_concatenate, 2, "~ & | >> << +", 10, 2, {{0, 255}, {0, 255}, {0, 255}}},
 {"isMult4", (funct_t) isMult4, (funct_t) test_isMult4, 1, "! ~ & ^ | + << >> ", 8, 4, {{1, TMax}, {1, TMax}, {1, TMax}}},
  {"", NULL, NULL, 0, "", 0, 0,
   {{0, 0},{0,0},{0,0}}}
};
